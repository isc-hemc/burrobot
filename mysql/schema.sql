...
--
-- Host: localhost    Database: burrobot
-- ------------------------------------------------------
...
CREATE TABLE `Message` (
  ...
  `no_stopwords_no_lemmas_msg` text,
  ...
  CONSTRAINT `fk_msg_1` FOREIGN KEY (`conversation_id`) REFERENCES `Conversation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
